...
const About = () => {
  return (
    <section className="py-5 bg-white min-vh-100" id="about">
        ...
        <Row className="g-4 align-items-start">
          ...
          <Col md={7} data-aos="fade-right" data-aos-delay="100">
            <Card className="mb-4 shadow-sm border-0">
              <Card.Body>
                <h3 className="h4 fw-semibold text-primary mb-3">My Background</h3>
                ...
                <Card className="bg-info bg-opacity-10 border-start border-4 border-primary mt-4" data-aos="fade-in" data-aos-delay="200">
                  <Card.Body>
                ...
                <Card className="bg-light border-0 mt-4" data-aos="fade-in" data-aos-delay="300">
                  <Card.Body>
